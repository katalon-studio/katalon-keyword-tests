...
ResponseObject response = WS.sendRequest(findTestObject('API Objects/Tips and Tricks/Verification/Verify simple response using built-in keywords', [('authorization') : GlobalVariable.authorization
            , ('issue_key') : 'KD-1']))
