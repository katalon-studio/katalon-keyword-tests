...
ResponseObject response = WS.sendRequest(findTestObject('API Objects/Tips and Tricks/RequestObject/Get Request information', [('issue_key') : 'KD-1', ('authorization') : GlobalVariable.authorization]))
RequestObject request = findTestObject('API Objects/Tips and Tricks/RequestObject/Get Request information', [('issue_key') : 'KD-1', ('authorization') : GlobalVariable.authorization])
