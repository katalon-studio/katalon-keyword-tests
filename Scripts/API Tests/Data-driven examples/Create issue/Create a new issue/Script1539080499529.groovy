...
def create_issue = WS.sendRequest(findTestObject('API Objects/Advance examples/api-2-issue/Create issue/Create a new issue with provided information', 
...
def new_issue = WS.sendRequest(findTestObject('API Objects/Advance examples/api-2-issue/Get issue/Get an issue by Key', 
	[('authorization') : GlobalVariable.authorization
